...
| Exporting notebook to script         | The logic for training the model is exported to a separate script                                                                                                                               | See [train.py](https://github.com/BuzzKanga/MLZoomcamp-2023-Mid-Term-Project/blob/main/train.py) and [predict.py](https://github.com/BuzzKanga/MLZoomcamp-2023-Mid-Term-Project/blob/main/predict.py)                                                                                                            |
